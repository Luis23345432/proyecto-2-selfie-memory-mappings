...
| Test | Proposito |
|---|---|
| `test-mmap-5-two-fds-shared.c` | Abre el mismo archivo dos veces, mapea ambos `fd` y verifica que ambos mappings comparten cache. |
| `test-mmap-6-lru-reuse.c` | Mapea y desmapea mas paginas que cache frames disponibles para validar reutilizacion LRU. |
